...
def run_decision_tree_xgb_cpu(dataset_name: str, random_state: int = 42):
    """
    运行 XGBoost（CPU）版的 Decision Tree Classifier
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Usage: python ml/DT_xgb_cpu.py <dataset_name>")
        print("Available datasets: iris, wine, breast_cancer, digits")
        sys.exit(1)

    dataset_name = sys.argv[1]
    result = run_decision_tree_xgb_cpu(dataset_name=dataset_name)
