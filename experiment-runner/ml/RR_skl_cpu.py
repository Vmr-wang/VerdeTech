...
def run_ridge_regression_sklearn(dataset_name: str, random_state: int = 42, alpha: float = 1.0):
    """
    运行 scikit-learn 的 Ridge Regression 并返回 runtime、MSE、R²
    """
    # 数据加载
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Usage: python ml/Ridge_skl.py <dataset_name> [alpha]")
    ...
    result = run_ridge_regression_sklearn(dataset_name=dataset_name, alpha=alpha)
